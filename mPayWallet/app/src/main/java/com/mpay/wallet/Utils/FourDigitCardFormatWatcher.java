...
public class FourDigitCardFormatWatcher implements TextWatcher {
     ...
     */
    public FourDigitCardFormatWatcher(int paddingPx) {
     ...
     */
    public FourDigitCardFormatWatcher(@NonNull TextView textView) {
     ...
     */
    public FourDigitCardFormatWatcher(@NonNull TextView textView, float paddingEm) {
     ...
     */
    public FourDigitCardFormatWatcher(@NonNull Context context, float paddingSp) {
